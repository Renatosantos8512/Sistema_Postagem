     ...
     <div class="row">
            ...
            <?php
               ...
               '<div class="alert alert-success">
                      ...
                      <strong>Olá, '.$nomeLogado.'!</strong> Seja Bem vindo ao <strong>SISTEMA HELP</strong> !
               </div>';
					}
				}
			 ?>  
            ...
            <div class="span12">	      		
	      		<div id="target-1" class="widget">	      			
	      			<div class="widget-content">	      				
			      		<h1>HELP</h1>
			      		<hr>
                <p>O <strong> O Sistema HELP </strong> É um Sistema de desenvolvido para analise da saude dos alunos do IFTO do campus do Paraiso,
                    cujo objetivo é mapear alunos com tedência ou inicio de ansiedade e depressão.
                       	<br>
                        O Sistema foi desenvolvido na linguagem <strong>PHP</strong>, utilizando juntamente com a classe <strong>PDO</strong>.
                    O banco de dados utilizado é o <strong>MySQL</strong>.</p>
                        
                        
                        <p><strong>Alunos do Cuso de Sistemas de Informação para a disciplina de
                                Residência 7º Perido de 2020.</strong></p>

<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
        ...
        <a class="brand" href="home.php">HELP ADMIN</a>
      <div class="nav-collapse">
        ...
        <form action="home.php?acao=ver-postagens" method="post" enctype="multipart/form-data" class="navbar-search pull-right">
          <input type="text"  name="palavra-busca" placeholder="pesquisar" ">
            <!--<input type="text" class="search-query" name="palavra-busca" placeholder="pesquisar" style="color:white;">-->
        </form>
      </div>
      <!--/.nav-collapse --> 
    </div>
...
<?php if(isset($_GET['acao'])){	$acao = $_GET['acao'];}else{$acao ='home';}?>    
      ...
      <ul class="mainnav">
        <li <?php if($acao =="welcome" || ($acao =="home")){echo 'class="active"';}?>><a href="home.php">
                <i class="icon-home"></i><span>Inicio</span> </a> </li>
        
        <?php if($nivelLogado ==1){?>
        <li class="<?php if($acao =="ver-postagens" || ($acao =="cad-postagem")){echo "active";}?> dropdown">
            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-file"></i><span>Postagens</span>
                <b class="caret"></b></a>
          <ul class="dropdown-menu">
